    ...
    >
      ...
      <CollapsibleContent>
        <div className="p-4 pt-0 space-y-4">
          ...
          {head && (
            <div className="mb-4">
              <h4 className="text-sm font-medium text-gray-500 mb-2">Department Head</h4>
              <div 
              ...
              >
                <Avatar className="h-8 w-8 mr-2">
                  ...
                  <AvatarFallback>{head.firstName.charAt(0)}{head.lastName.charAt(0)}</AvatarFallback>
                </Avatar>
                <div>
                  <div className="text-sm font-medium">{head.firstName} {head.lastName}</div>
                  <div className="text-xs text-gray-500">{head.position}</div>
                </div>
              </div>
            </div>
          )}
          ...
          {managers.length > 0 && (
            <div className="space-y-4">
              ...
              {managers.map(manager => (
                <div key={manager.id} className="pl-4 border-l-2 border-gray-200">
                  <div 
                    className="flex items-center p-2 rounded-md hover:bg-gray-50 cursor-pointer"
          ...
          {unassignedUsers.length > 0 && (
            <div className="mt-4">
              <h4 className="text-sm font-medium text-gray-500 mb-2">Other Team Members</h4>
