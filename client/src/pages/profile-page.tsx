        ...
        <Card>
          <CardContent className="pt-6">
            <div className="text-center py-10">
              ...
              <p className="text-gray-500 mb-6">The requested employee profile could not be found.</p>
      ...
      <Card>
        ...
        <CardContent>
          <div className="flex items-center space-x-4 mb-6">
            ...
            <div>
              <h2 className="text-xl font-semibold">{profileUser.firstName} {profileUser.lastName}</h2>
